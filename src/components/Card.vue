...
const isRedSuit = computed(() => props.suit === "Hearts" || props.suit === "Diamonds");
const isBlackSuit = computed(() => props.suit === "Clubs" || props.suit === "Spades");
...
<template>
  <div class="group perspective min-h-[180px] min-w-[120px] md:min-h-[120px] md:min-w-[80px]">
